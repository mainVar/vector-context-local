...
module.exports = {
    ...
    resolve: {
        ...
        extensions: ['.ts', '.js'],
        alias: {
            '@vector-context/core': path.resolve(__dirname, '../core/dist/index.js'),
            '@vector-context/core/dist/splitter': path.resolve(__dirname, '../core/dist/splitter'),
            '@vector-context/core/dist/embedding': path.resolve(__dirname, '../core/dist/embedding'),
            '@vector-context/core/dist/vectordb': path.resolve(__dirname, '../core/dist/vectordb')
        }
    },
    module: {
        rules: [
